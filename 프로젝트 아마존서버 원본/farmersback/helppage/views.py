...
def help_create(request):
    ...
    helpmodel = HelpModel.objects.create(help_select=help_select, title=title, location1=location1, location2=location2, help_date=help_date, people=people, content=content, user=user)
