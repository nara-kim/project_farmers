      ...
      <div class="container">
         <div class="row">
            ...
            <div class="d-flex justify-content-end">
               <button class = "btn btn-lg" style="margin-top:10px; border-radius: 12px; background-color:#FFE4B5;">
                  <router-link to ='view_board_write' style="font-family:'Jua', sans-serif; font-size:18px;">
                     글쓰기
                  </router-link>
               </button>
            </div>
...
export default {
   ...
   methods: {
      gethelp(){
         axios
            .get('http://15.165.77.204:8000/helppage/gethelp/')
            .then(res => {
      ...
      locationhelp(){
            ...
            axios.post('http://15.165.77.204:8000/helppage/locationhelp/', formData)
            .then(response => {
