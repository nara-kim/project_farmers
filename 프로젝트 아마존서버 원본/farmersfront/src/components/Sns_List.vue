<template>
    <div class="cardbox shadow-lg bg-white">
        <div class="cardbox-heading">
            ...
            <div class="media m-0">
              ...
              <div class="media-body">
                  <img v-bind:src="`http://15.165.77.204:8000${userinfo.image}/`" style="border-radius:70%; width:10px; border:none;">{{sns.nickname}}
              </div>
            </div>
          </div>
        <div class="cardbox-item" style="text-align:center;">
            <img class="img-fluid" v-bind:src="`http://15.165.77.204:8000${sns.image}/`" alt="Image" style="width:60%;">
        </div>
        ...
        <div class="cardbox-comments">
            ...
            <div class="search">
              <input placeholder="Write a comment" type="text" maxlength="50" v-model="comment.content">
            ...
            <div class="comment" v-for='comment in comments' :key='comment.id'>
                <h5 class="h5comment d-flex justify-content-start" style="margin-left:50px;">
                  <span style="padding: 5px 10px 0 0;">
                    <img src="img/user.png" style="border-radius:70%; width:15px; border:none;">
                    <span style="font-family: 'Jua', sans-serif; margin-left:10px;">{{comment.username}}:
                  ...
                  <button class="btn btn-danger" v-if="comment.create_user === loggedInUser.user_id" @click.prevent="commentCheck(comment)" style="height:25px; width:auto;">
                    <img class="deletebutton" src="img/delete.png" style="float:right;">
                  </button>
                </h5>
            </div>
        </div> 
...
export default {
    ...
    methods: {
        commentCreate(sns){
            ...
            axios
                .post(`http://15.165.77.204:8000/sns/todo/${sns_id.id}/commentcreate/`,form)
                .then((res)=>{
        ...
        getUser(){
          axios
            .get(`http://15.165.77.204:8000/sns/todo/${this.sns.id}/getuser/`)
            .then((res)=>{
        ...
        getComment(){
            axios
                .get(`http://15.165.77.204:8000/sns/todo/${this.sns.id}/comment/`)
                .then((res)=>{
        ...
        commentDelete(comment){
          ...
          axios
            .delete(`http://15.165.77.204:8000/sns/todo/${comment_id.id}/comment/`, this.requestHeader)
            .then((res)=>{
              alert('댓글이 삭제되었습니다.')
              console.log(res)
              this.getComment()
        ...
        snsDelete(sns){
          const sns_id = sns
          axios
            .delete(`http://15.165.77.204:8000/sns/todo/${sns_id.id}/snsdelete/`, this.requestHeader)
            .then((res)=>{
              console.log(res)
