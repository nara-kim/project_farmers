      ...
      <div class="container">
          ...
          <div class="row">
              ...
              <div class="col-md-6 contact-widget-section2 wow animated fadeInLeft" data-wow-delay=".2s">
                ...
                <hr>
                <img class="img-fluid" v-bind:src="`http://15.165.77.204:8000${mypage.image}/`" alt="프로필 사진을 등록해주세요" style="width:50%; border-radius:70%">
                </div>
              </div>
              <!-- contact form -->
...
export default {
    ...
    methods:{
        getMypage(userid){
            ...
            axios
                .get(`http://15.165.77.204:8000/auth/accounts/mypage/${userid}/`,requestHeader)
                .then(res => {
                    const {data} = res
                    this.mypage = data
                })
        ...
        inImage(userid){
            ...
            axios
                .post(`http://15.165.77.204:8000/auth/accounts/inimage/${userid}/`, formData,this.imgrequestHeader)
                .then((res)=>{
