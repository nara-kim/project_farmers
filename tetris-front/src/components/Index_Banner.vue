...
<div class="container">
<div class="video-part-content" style="background-image:url('img/back6.png');   background-repeat: no-repeat; background-size: cover; background-position: center;">
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      ...
      <center>
      <img src="" class="img-responsive animated fadeInDown">
      </center>
      <div class="full-width animated fadeInUp">
        <h1 class = "h1">Welcome to Farmers!</h1>
        <p class = "p">Faithfulness makes all things possible.</p>
        <p class = "p">성실함은 모든것을 가능케 한다.</p>
...
.video-part-content
{
	...
	height: 100%;
	padding-top: 8%;
	background:rgba(255, 158, 31, 0.5);
}
